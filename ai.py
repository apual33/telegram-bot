...
def _system_prompt(report_email: str = "") -> str:
    ...
    return (
        ...
        "You MUST use the appropriate tool for every action — create_todo to save tasks, complete_todo to mark them done, list_todos to show them. NEVER just describe what you would do.\n\n"
        ...
        "- complete_todo: call when user wants to delete, remove, or complete/finish a task — no exceptions. "
        "You MUST call list_todos first to get current IDs, then call complete_todo with the correct id. "
        "NEVER guess an ID. NEVER describe this action without calling the tool. "
